...
from database import (
    ...
    authenticate_local,authenticate_oauth,get_user_by_id,   
    get_user_by_email,create_user,add_auth_provider,update_password,
...
# ========== MODIFIER LA ROUTE DE LOGIN EXISTANTE ==========

# REMPLACER la route /login POST par :
